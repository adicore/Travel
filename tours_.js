...
jQuery.ajax(tab1).done(function (t1){
    var blockbody = '';
        for(var i=0;i<t1.products.length;i++){
            ...
            blockbody+="<div class='col-lg-4 responsive-column'><div class='card-item trending-card'><div class='card-img'><a class='d-block' href='"+productUrl+"' rel='"+rel+"' target='"+target+"'><img alt='"+title+"' src='"+img+"'/></a><span class='badge'>Bestseller</span></div><div class='card-body'><h3 class='card-title'><a href='"+productUrl+"' rel='"+rel+"' target='"+target+"'>"+title+"</a></h3><div class='card-price d-flex align-items-center justify-content-between'><p><span class='price__num'>"+curency+""+price+"</span></p><a class='btn-text' href='"+productUrl+"' rel='"+rel+"' target='"+target+"'>View details<i class='la la-angle-right'></i></a></div></div></div></div>";
